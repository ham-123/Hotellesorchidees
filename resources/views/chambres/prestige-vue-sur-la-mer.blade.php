...
@section('title', 'Chambre Prestige Vue sur la Mer')
...
@section('content')
    ...
    <div class="full-row overlay-secondery-opacity-65 bg-img-5" id="page-banner">
        <div class="container">
            <div class="row py-80">
                <div class="col-sm-6">
                    <h1 class="banner-title text-white">Chambre Prestige Vue sur la Mer</h1>
                </div>
                <div class="col-sm-6">
                    <ul class="pages-link">
                        ...
                        <li>/</li>
                        <li>Chambre Prestige Vue sur la Mer</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!-- Début de la vue détaillée de la chambre prestige vue sur la mer -->
    <section class="full-row bg-white py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ asset('img/chambres/4.jpg') }}" alt="Chambre Prestige Vue sur la Mer" class="img-fluid mb-4">
                </div>
                <div class="col-md-6">
                    <h1 class="mb-4">Chambre Prestige Vue sur la Mer</h1>
                    <p>Nombre de chambres: <strong>7</strong></p>
                    <h3 class="mb-3">Tarifs (TVA et taxes de séjour incluses):</h3>
                    <ul class="list-group mb-4">
                        <li class="list-group-item">Une personne avec petit-déjeuner: <strong>96,500</strong></li>
                        <li class="list-group-item">Une personne sans petit-déjeuner: <strong>91,500</strong></li>
                        <li class="list-group-item">Deux personnes avec petit-déjeuner: <strong>106,500</strong></li>
                        <li class="list-group-item">Deux personnes sans petit-déjeuner: <strong>96,500</strong></li>
                    </ul>
    ...
    <!-- Fin de la vue détaillée de la chambre prestige vue sur la mer -->
@endsection
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const tarifs = {
            '1_person_avec_petit_dejeuner': 96500,
            '1_person_sans_petit_dejeuner': 91500,
            '2_persons_avec_petit_dejeuner': 106500,
            '2_persons_sans_petit_dejeuner': 96500
        };
